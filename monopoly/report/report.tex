...
Code: \url{https://github.com/Selim-Emir-Can/CS348K-proj/tree/master}.
\end{abstract}
...
\texttt{FreeParking}-substitution path is retained for the
canonical-layout rendering only). Identity vector $=$ the default board.
