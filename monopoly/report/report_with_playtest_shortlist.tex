% =====================================================================
% Final report: agent-driven closed-loop game-design optimisation for
% Monopoly. An N=10 two-player human playtest pilot was run (see
% sec:playtest-pilot); the fuller multi-subject playtest remains
% deferred and is specified as a falsification-plan board shortlist in
% the appendix (sec:playtest-shortlist).
% Build with lualatex (microtype needs scalable fonts).
% =====================================================================
