...
change will play in real life. A three-phase validation plan
(simplified-board sanity check, human playtest, LLM-agent cross-check)
operationalises this claim. Phase A is complete: on a 16-cell mini
board with three pre-declared design knobs, two independent agent
classes (rule-based + a Qwen2.5-1.5B LLM) agree on direction for
$8/12$ metric comparisons and \emph{cross-confirm a counterintuitive
finding} (doubling salary increases draw rate from $50\%$ to
$75$--$90\%$ rather than reducing it).
Code:
